...
- Activate the virtual environment (it must be activated each time a new console is opened):
  ...
  Optinally [`direnv`](https://direnv.net/) can be used to automate the activation/deactivation of the python virtual environment upon entering/exiting the project folder.
